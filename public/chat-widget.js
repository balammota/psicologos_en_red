(function () {
    ...
    wrap.innerHTML =
        ...
        '</button>' +
        '<div class="chat-widget-panel" id="chat-widget-panel" role="dialog" aria-label="Chat">' +
        '<div class="chat-widget-header">' +
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12c0 1.54.36 3 .97 4.29L2 22l5.71-.97C9 21.64 10.46 22 12 22c5.52 0 10-4.48 10-10S17.52 2 12 2z"/></svg>' +
        '<span>Asistente Psicólogos en Red</span>' +
        '</div>' +
    ...
    function setLoading(show) {
        var existing = messagesEl.querySelector('.chat-widget-typing');
    ...
    btn.addEventListener('click', function () {
        ...
        if (panel.classList.contains('open')) {
            ...
            if (messagesEl.children.length === 0) {
                addMessage('Hola, soy el asistente de Psicólogos en Red. ¿En qué puedo ayudarte? (horarios, agendar, servicios, precios)', 'bot');
            }
        }
    });
